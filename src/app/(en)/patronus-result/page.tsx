      ...
      <div className="flex items-center justify-center min-h-screen py-8">
        <div className="max-w-4xl w-full bg-gray-900/30 border-2 border-blue-400 rounded-2xl p-8 shadow-[0_0_20px_rgba(100,150,255,0.3)] backdrop-blur-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl text-blue-200 mb-4 font-harry">Your Patronus is a {patronusData.displayName[currentLang]}</h1>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl text-blue-200 mb-2 font-harry">Traits</h2>
              ...
              <div>
                <h2 className="text-xl text-blue-200 mb-2 font-harry">Famous Wizards</h2>
                <div className="flex flex-wrap gap-2">

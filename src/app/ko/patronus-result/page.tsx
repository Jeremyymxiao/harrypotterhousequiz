  ...
  if (!patronusData) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <h1 className="text-2xl text-blue-200 mb-4">패트로누스 결과를 찾을 수 없습니다</h1>
        <Link href="/ko/patronus-quiz" className="magic-button px-6 py-3 text-blue-200 border-2 border-blue-400 rounded-lg">
          패트로누스 테스트 하기
        </Link>
      </div>
    )
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-gray-900/30 border-2 border-blue-400 rounded-2xl p-8 shadow-[0_0_20px_rgba(100,150,255,0.3)] backdrop-blur-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl text-blue-200 mb-4 font-harry">당신의 패트로누스는 {patronusData.displayName[currentLang]} 입니다</h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">특성</h2>
            ...
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">유명한 마법사</h2>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="flex flex-col items-center space-y-4">
          <h2 className="text-xl text-blue-200 font-harry">결과 공유하기</h2>
          ...
          <div className="flex gap-4">
            ...
            <TwitterShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`내 패트로누스는 ${patronusData.displayName.ko} 입니다! 당신의 패트로누스는 무엇인가요?`}>
              <TwitterIcon size={40} round />
            </TwitterShareButton>
            
            <WhatsappShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`내 패트로누스는 ${patronusData.displayName.ko} 입니다! 당신의 패트로누스는 무엇인가요?`}>
              <WhatsappIcon size={40} round />
            </WhatsappShareButton>
            
            <RedditShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`내 패트로누스는 ${patronusData.displayName.ko} 입니다! 당신의 패트로누스는 무엇인가요?`}>
          ...
          <Link href="/ko/patronus-quiz" className="magic-button px-6 py-3 text-blue-200 border-2 border-blue-400 rounded-lg mt-2">
            테스트 다시 하기
          </Link>
        </div>
      </div>

...
export const metadata = {
  ...
  description: 'Begin your magical journey with our Harry Potter Sorting Hat Quiz. Answer enchanting questions to reveal your true Hogwarts house - Gryffindor, Ravenclaw, Hufflepuff, or Slytherin!',
  openGraph: {

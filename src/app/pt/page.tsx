    ...
    <div className="magic-bg min-h-screen w-full">
      ...
      <section className="relative z-10 w-full px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Mais Aventuras Mágicas */}
          <div className="mt-8 pt-8 border-t border-amber-400/20">
            <h3 className="text-2xl font-magic text-amber-400 text-center mb-6">Mais Aventuras Mágicas</h3>
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-center">
              <Link 
                href="/pt/patronus-quiz"
                className="magic-button px-6 py-3 text-lg font-magic text-blue-200 border-2 border-blue-400 rounded-lg 
              ...
              <Link 
                href="/pt/harry-potter-house-quiz-for-kids"
                className="magic-button px-6 py-3 text-lg font-magic text-purple-200 border-2 border-purple-400 rounded-lg 
              ...
              <Link 
                href="/pt/hogwarts-enrollment-qa"
                className="magic-button px-6 py-3 text-lg font-magic text-red-200 border-2 border-red-400 rounded-lg 

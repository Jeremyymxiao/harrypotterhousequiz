    ...
    <div className="patronus-bg min-h-screen w-full">
      ...
      <section className="relative z-10 pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-200 font-magic mb-6 max-w-3xl mx-auto">
            "Expecto Patronum! Um Patrono é uma força positiva, uma projeção daquilo que os dementadores se alimentam - esperança, felicidade, desejo de sobreviver."
          </p>
      ...
      <section className="relative z-10 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-harry text-blue-400 text-center mb-8">Guardiões Mágicos</h2>
            ...
            {patronusesToDisplay.map((patronus: Patronus) => (
              ...
              >
                <div className="p-6">
                  <div className="flex flex-col md:flex-row items-center mb-4">
                    <div className="w-full md:w-1/3 flex justify-center mb-4 md:mb-0 md:mr-4">
                      <div className="relative w-28 h-28 overflow-hidden">
                        <Image
                          ...
                          alt={`Patrono ${patronus.displayName.pt || patronus.displayName.en}`}
                          width={112}
                          height={112}
                    ...
                    <div className="md:w-2/3 text-center md:text-left">
                      <h3 className="text-2xl font-harry text-blue-200">
                        {patronus.displayName.pt || patronus.displayName.en}
                      </h3>
                      <div className="text-sm text-blue-400 font-harry uppercase tracking-wider">
                        {patronus.type === 'strength' ? 'Força' : 
                         patronus.type === 'wisdom' ? 'Sabedoria' : 
                         patronus.type === 'protection' ? 'Proteção' : 
                         patronus.type === 'agility' ? 'Agilidade' : ''}
                      </div>
                    </div>
                  </div>
                  
                  <p className="text-blue-100 mb-4">
                    {patronus.description.pt || patronus.description.en}
                  </p>
                  
                  <div className="mb-4">
                    <h4 className="text-blue-300 font-harry mb-2">Características:</h4>
                    <div className="flex flex-wrap gap-2">
                      {(patronus.traits.pt || patronus.traits.en).map((trait, index) => (
                        <span 
                          key={index}
                  ...
                  {(patronus.famousWizards.pt || patronus.famousWizards.en).length > 0 && (
                    <div>
                      <h4 className="text-blue-300 font-harry mb-2">Bruxos Famosos:</h4>
                      <p className="text-blue-100">{(patronus.famousWizards.pt || patronus.famousWizards.en).join(', ')}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section className="relative z-10 py-12 px-4 bg-black/30 backdrop-blur-sm">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-harry text-blue-400 mb-6">Pronto para encontrar seu guardião?</h2>
          <p className="text-blue-200 mb-6 font-harry">
            O Feitiço do Patrono é um dos mais poderosos feitiços defensivos no mundo mágico.
            Descubra qual criatura mágica representa sua luz interior e o protegerá contra a escuridão.
          </p>
          <button 
            onClick={() => setStartQuiz(true)}
            className="magic-button px-8 py-4 text-2xl font-harry text-blue-200 border-2 border-blue-400 rounded-lg 

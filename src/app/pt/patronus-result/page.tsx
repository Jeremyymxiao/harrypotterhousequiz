  ...
  if (!patronusData) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <h1 className="text-2xl text-blue-200 mb-4">Nenhum resultado de Patrono encontrado</h1>
        <Link href="/pt/patronus-quiz" className="magic-button px-6 py-3 text-blue-200 border-2 border-blue-400 rounded-lg">
          Faça o Teste do Patrono
        </Link>
      </div>
    )
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full bg-gray-900/30 border-2 border-blue-400 rounded-2xl p-8 shadow-[0_0_20px_rgba(100,150,255,0.3)] backdrop-blur-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl text-blue-200 mb-4 font-harry">Seu Patrono é um {patronusData.displayName[currentLang]}</h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">Características</h2>
            ...
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">Bruxos Famosos</h2>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="flex flex-col items-center space-y-4">
          <h2 className="text-xl text-blue-200 font-harry">Compartilhe seu resultado</h2>
          ...
          <div className="flex gap-4">
            ...
            <TwitterShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Meu Patrono é um ${patronusData.displayName.pt}! Qual é o seu?`}>
              <TwitterIcon size={40} round />
            </TwitterShareButton>
            
            <WhatsappShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Meu Patrono é um ${patronusData.displayName.pt}! Qual é o seu?`}>
              <WhatsappIcon size={40} round />
            </WhatsappShareButton>
            
            <RedditShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Meu Patrono é um ${patronusData.displayName.pt}! Qual é o seu?`}>
          ...
          <Link href="/pt/patronus-quiz" className="magic-button px-6 py-3 text-blue-200 border-2 border-blue-400 rounded-lg mt-2">

      ...
      <div className="max-w-4xl w-full bg-gray-900/30 border-2 border-blue-400 rounded-2xl p-8 shadow-[0_0_20px_rgba(100,150,255,0.3)] backdrop-blur-md">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">Характеристики</h2>
            ...
            <div>
              <h2 className="text-xl text-blue-200 mb-2 font-harry">Известные волшебники</h2>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="flex flex-col items-center space-y-4">
          <h2 className="text-xl text-blue-200 font-harry">Поделиться результатом</h2>
          ...
          <div className="flex gap-4">
            ...
            <TwitterShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Мой Патронус - ${patronusData.displayName.ru}! А какой у тебя?`}>
              <TwitterIcon size={40} round />
            </TwitterShareButton>
            
            <WhatsappShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Мой Патронус - ${patronusData.displayName.ru}! А какой у тебя?`}>
              <WhatsappIcon size={40} round />
            </WhatsappShareButton>
            
            <RedditShareButton url={typeof window !== 'undefined' ? window.location.href : ''} title={`Мой Патронус - ${patronusData.displayName.ru}! А какой у тебя?`}>

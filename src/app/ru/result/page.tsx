...
// Компонент карточки для скачивания
    ...
    return (
      <div className="magic-bg min-h-screen flex items-center justify-center">
        <div className="magic-card p-8">
          <div className="text-2xl text-amber-400 animate-pulse font-harry">Загрузка...</div>
        </div>
      </div>
    )
  }
    ...
    <main className="magic-bg min-h-screen p-4">
      ...
      <div className="flex items-center justify-center min-h-screen py-8">
        ...
        <div className="pt-8 space-x-4">
          ...
          >
            {isDownloading ? 'Создание...' : 'Скачать сертификат'}
          </button>
        </div>
        ...
        <div className="mt-6 flex justify-center space-x-4 flex-wrap gap-y-4">
          ...
          <TwitterShareButton
            url={shareUrl}
            title={`Я распределен в ${houseData.displayName[currentLang]} в Хогвартсе! Узнай свой факультет! 🧙‍♂️✨`}
            className="hover:opacity-80 transition-opacity"
          >

    ...
    <div className="patronus-bg min-h-screen w-full">
      ...
      <section className="relative z-10 pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl text-blue-400 font-magic-zh mb-6">
            发现你的守护神
          </h1>
          <p className="text-xl md:text-2xl text-blue-200 font-magic-zh mb-6 max-w-3xl mx-auto">
            "呼神护卫！守护神是一种积极的力量，是摄魂怪所吞噬的东西的投射 - 希望，幸福，生存的欲望。"
          </p>
          
          <button 
            onClick={() => setStartQuiz(true)}
            className="magic-button px-8 py-4 text-2xl font-magic-zh text-blue-200 border-2 border-blue-400 rounded-lg 
      ...
      <section className="relative z-10 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-magic-zh text-blue-400 text-center mb-8">魔法守护者</h2>
          
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <button 
              onClick={() => setSelectedType('all')}
              className={`px-4 py-2 rounded-md font-magic-zh text-lg transition-all
                ${selectedType === 'all' 
                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row items-center mb-4">
                    <div className="w-full md:w-1/3 flex justify-center mb-4 md:mb-0 md:mr-4">
                      <div className="relative w-28 h-28 overflow-hidden">
                        <Image
                          ...
                          alt={`${patronus.displayName.zh} 守护神`}
                          width={112}
                          height={112}
                    ...
                    <div className="md:w-2/3 text-center md:text-left">
                      <h3 className="text-2xl font-magic-zh text-blue-200">
                        {patronus.displayName.zh}
                      </h3>
                      <div className="text-sm text-blue-400 font-magic-zh uppercase tracking-wider">
                        {patronus.type === 'strength' ? '力量型' : 
                         patronus.type === 'wisdom' ? '智慧型' : 
                         patronus.type === 'protection' ? '守护型' : 
                  ...
                  <p className="text-blue-100 mb-4">
                    {patronus.description.zh}
                  </p>
                  
                  <div className="mb-4">
                    <h4 className="text-blue-300 font-magic-zh mb-2">特点：</h4>
                    <div className="flex flex-wrap gap-2">
                      {patronus.traits.zh.map((trait, index) => (
                        <span 
                          key={index}
                  ...
                  {patronus.famousWizards.zh.length > 0 && (
                    <div>
                      <h4 className="text-blue-300 font-magic-zh mb-2">著名巫师：</h4>
                      <p className="text-blue-100">{patronus.famousWizards.zh.join('、')}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section className="relative z-10 py-12 px-4 bg-black/30 backdrop-blur-sm">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-magic-zh text-blue-400 mb-6">准备好找到你的守护者了吗？</h2>
          <p className="text-blue-200 mb-6 font-magic-zh">
            守护神咒是魔法世界中最强大的防御性咒语之一。
            找出哪种魔法生物代表着你内心的光明，将保护你免受黑暗侵袭。
          </p>
          <button 
            onClick={() => setStartQuiz(true)}
            className="magic-button px-8 py-4 text-2xl font-magic-zh text-blue-200 border-2 border-blue-400 rounded-lg 
